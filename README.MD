...
```javascript
const StaffBaseSSO = require('staffbase-plugin-sdk').sso
```
## About secret token
...
```javascript
const helpers = require(`staffbase-plugin-sdk`).helpers
...
const SSOMiddleware = require('staffbase-plugin-sdk').middleware;
